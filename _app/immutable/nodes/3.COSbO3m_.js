import{w as rt,a as u,f as y,c as tt,t as et}from"../chunks/I0AGUu3X.js";import{h as it,a0 as nt,V as h,_ as Y,a1 as at,W as o,Z as a,w as v,$ as w,X as ft,a2 as X,Y as dt,a3 as ut}from"../chunks/D623fXL-.js";import{s as E}from"../chunks/DsmpRkHX.js";import{i as I}from"../chunks/BcnujHhF.js";import{e as K,i as Z,r as _t,s as R,a as bt}from"../chunks/BJjor23F.js";const st=[...` 	
...
`):"")+`
    ...
    <\/script></div></main>`,1));function Jt(s,t){nt(t,!0);const e=yt(t.data.variable),i=t.data.path.split("/").slice(0,-1).map(()=>"..").join("/");var r=zt(),c=Y(r),n=o(c);wt(n,{get selected(){return t.data.path},get variables(){return t.data.variableList}}),a(c);var m=h(c,2),x=o(m),j=o(x),k=o(j),L=o(k,!0);a(k);var B=h(k,2),F=o(B);{var P=f=>{var O=Pt();w(()=>R(O,"href",t.data.issue)),u(f,O)};I(F,f=>{t.data.issue&&f(P)})}var $=h(F,2),d=o($);a($),a(B);var l=h(B,2),b=o(l,!0);a(l),a(j);var _=h(j,2),g=o(_),S=h(o(g),2);{let f=X(()=>e.getProperty());H(S,()=>v(f))}var T=h(S,4);{let f=X(()=>e.getObjectOfInterest());H(T,()=>v(f))}var J=h(T,2);{var z=f=>{var O=$t(),N=h(Y(O),2);{let U=X(()=>e.getStatisticalModifier());H(N,()=>v(U))}u(f,O)};I(J,f=>{e.getStatisticalModifier()&&f(z)})}var A=h(J,2);{var W=f=>{var O=At(),N=h(Y(O),2);{let U=X(()=>e.getMatrix());H(N,()=>v(U))}u(f,O)};I(A,f=>{e.getMatrix()&&f(W)})}var C=h(A,2);{var p=f=>{var O=Tt(),N=h(Y(O),2);K(N,17,()=>e.getContextObjects(),Z,(U,mt)=>{H(U,()=>v(mt))}),u(f,O)};I(C,f=>{e.getContextObjects().length>0&&f(p)})}a(g),a(_),a(x);var V=h(x,4),G=o(V);dt(2),a(V),a(m),w((f,O,N)=>{E(L,f),R($,"href",`${i}/${t.data.path}`),R(d,"src",`${i}/rdf.svg`),E(b,O),R(G,"src",`https://sirkos.github.io/iadopt-vis/remote.html?jsonld=${N??""}`)},[()=>e.getLabel(),()=>e.getComment(),()=>encodeURIComponent(JSON.stringify(t.data.variable))]),u(s,r),at()}export{Jt as component};
