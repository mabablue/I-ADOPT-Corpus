import{w as rt,a as u,f as y,d as tt,t as et}from"../chunks/k4wAg8bh.js";import{h as it,Z as nt,U as h,V as Y,_ as at,W as o,X as a,v,Y as w,aD as ft,$ as X,an as dt,a0 as ut}from"../chunks/DhcB5iC7.js";import{s as E}from"../chunks/BtQm3cYI.js";import{i as I}from"../chunks/DYb9dtZK.js";import{e as K,i as Z,r as _t,s as R,a as bt}from"../chunks/CP68CU9S.js";const st=[...` 	
...
`+Object.entries(this._comment).map(([t,e])=>`    ${t}: ${e}`).join(`
`):"")+`
]`}}function yt(s){const t=new ct({iri:s["@id"],label:s.label,comment:s.comment}),e={};let i=N(s.property,vt,e);if(i&&t.setProperty(i),i=N(s.statisticalModifier,M,e),i&&t.setStatisticalModifier(i),i=N(s.ooi,M,e),i&&t.setObjectOfInterest(i),i=N(s.matrix,M,e),i&&t.setMatrix(i),s.context)for(const r of s.context)i=N(r,M,e),t.addContextObject(i);if(s.constraint)for(const r of s.constraint){let{constraint:c,entities:n}=Ct(r);n=n.map(m=>e[m]),t.addConstraint(c,...n)}return t}function N(s,t,e){if(!s)return;const i=new t({iri:s["@id"],label:s.label,comment:s.comment,isBlank:!("@id"in s)||s["@id"].startsWith("_:")});e[s["@id"]]=i;for(const r of Q)if(r in s){const c=Array.isArray(s[r])?s[r].map(n=>N(n,t,e)):[N(s[r],t,e)];for(const n of c)i.addComponent(r,n),e[n.getIri()]=n}return i}function Ct(s){if(s)return{constraint:new ht({iri:s["@id"],label:s.label,comment:s.comment}),entities:s.constrains}}var xt=y('<a class="navBoxItem"><li> </li></a>'),Ot=y('<li class="navBoxSection svelte-10b7788"><label class="svelte-10b7788"><i> </i></label> <input type="checkbox" class="svelte-10b7788"/> <ul class="svelte-10b7788"></ul></li>'),St=rt(y(`<div class="navBox svelte-10b7788"><div class="navBoxHead">Filter</div> <div class="navBoxBody filterBody svelte-10b7788"><input type="text" id="filter" placeholder="Filter Variables ..."/> <script>
      (function(){
    ...
    <\/script></div></main>`,1));function Jt(s,t){nt(t,!0);const e=yt(t.data.variable),i=t.data.path.split("/").slice(0,-1).map(()=>"..").join("/");var r=zt(),c=Y(r),n=o(c);wt(n,{get selected(){return t.data.path},get variables(){return t.data.variableList}}),a(c);var m=h(c,2),x=o(m),j=o(x),k=o(j),L=o(k,!0);a(k);var B=h(k,2),F=o(B);{var P=f=>{var O=Pt();w(()=>R(O,"href",t.data.issue)),u(f,O)};I(F,f=>{t.data.issue&&f(P)})}var $=h(F,2),d=o($);a($),a(B);var l=h(B,2),b=o(l,!0);a(l),a(j);var _=h(j,2),g=o(_),S=h(o(g),2);{let f=X(()=>e.getProperty());H(S,()=>v(f))}var T=h(S,4);{let f=X(()=>e.getObjectOfInterest());H(T,()=>v(f))}var J=h(T,2);{var z=f=>{var O=$t(),D=h(Y(O),2);{let G=X(()=>e.getStatisticalModifier());H(D,()=>v(G))}u(f,O)};I(J,f=>{e.getStatisticalModifier()&&f(z)})}var A=h(J,2);{var U=f=>{var O=At(),D=h(Y(O),2);{let G=X(()=>e.getMatrix());H(D,()=>v(G))}u(f,O)};I(A,f=>{e.getMatrix()&&f(U)})}var C=h(A,2);{var p=f=>{var O=Tt(),D=h(Y(O),2);K(D,17,()=>e.getContextObjects(),Z,(G,mt)=>{H(G,()=>v(mt))}),u(f,O)};I(C,f=>{e.getContextObjects().length>0&&f(p)})}a(g),a(_),a(x);var V=h(x,4),W=o(V);dt(2),a(V),a(m),w((f,O,D)=>{E(L,f),R($,"href",`${i}/${t.data.path}`),R(d,"src",`${i}/rdf.svg`),E(b,O),R(W,"src",`https://sirkos.github.io/iadopt-vis/remote.html?jsonld=${D??""}`)},[()=>e.getLabel(),()=>e.getComment(),()=>encodeURIComponent(JSON.stringify(t.data.variable))]),u(s,r),at()}export{Jt as component};
